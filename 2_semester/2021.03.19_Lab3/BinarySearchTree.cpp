...
template<typename T1, typename T2>
Map<T1, T2>::Map(const Map<T1, T2> &rhs):size_(0), root_(shared_ptr<Node>(nullptr))
{
    this->RecursiveCopy(rhs.root_);
}

template<typename T1, typename T2>
Map<T1, T2>::Map(Map<T1, T2> &&rhs) noexcept: size_(0), root_(shared_ptr<Node>(nullptr))
{
    this->Clear();
...
template<typename T1, typename T2>
void Map<T1, T2>::Add(const pair<T1, T2> &new_item)
{
...
template<typename T1, typename T2>
void Map<T1, T2>::Delete(const T1 &key)
{
...
template<typename T1, typename T2>
constexpr bool Map<T1, T2>::Has(const T1 &key) const noexcept
{
...
template<typename T1, typename T2>
constexpr T2 Map<T1, T2>::FindNext(const T1 &key) const
{
    return ((this->NextElement(this->FindElement(key)))->value_).second;
}

template<typename T1, typename T2>
constexpr T2 Map<T1, T2>::FindPrevious(const T1 &key) const
{
    return ((this->PreviousElement(this->FindElement(key)))->value_).second;
}

template<typename T1, typename T2>
ostream &operator<<(ostream &os, const Map<T1, T2> &element)
{
...
template<typename T1, typename T2>
Map<T1, T2> &Map<T1, T2>::operator=(Map<T1, T2> &&rhs) noexcept
{
    this->Clear();
    this->root_ = rhs.root_;
    auto rhs_left = rhs.root_->left_child_,
...
template<typename T1, typename T2>
void Map<T1, T2>::RecursiveCopy(const shared_ptr<Node> &rhs)
{
...
template<typename T1, typename T2>
shared_ptr<typename Map<T1, T2>::Node> Map<T1, T2>::FindElement(const T1 &key) const
{
...
template<typename T1, typename T2>
void Map<T1, T2>::DeleteByPointer(shared_ptr<Node> &target)
{
...
template<typename T1, typename T2>
shared_ptr<typename Map<T1, T2>::Node> Map<T1, T2>::GetMaximumValue(const shared_ptr<Node> &start) const noexcept
{
    auto response = start;
...
template<typename T1, typename T2>
shared_ptr<typename Map<T1, T2>::Node> Map<T1, T2>::GetMinimumValue(const shared_ptr<Node> &start) const noexcept
{
    auto response = start;
...
template<typename T1, typename T2>
shared_ptr<typename Map<T1, T2>::Node> Map<T1, T2>::NextElement(shared_ptr<Node> target) const
{
...
template<typename T1, typename T2>
shared_ptr<typename Map<T1, T2>::Node> Map<T1, T2>::PreviousElement(shared_ptr<Node> target) const
{
...
template<typename T1, typename T2>
void Map<T1, T2>::DeleteTree(shared_ptr<Node> &node)
{
