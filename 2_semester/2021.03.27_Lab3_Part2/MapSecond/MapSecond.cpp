...
MapSecond<T1, T2>::MapSecond():size_(0), root_(shared_ptr<Node>(nullptr))
{}

template<typename T1, typename T2>
MapSecond<T1, T2>::MapSecond(const MapSecond<T1, T2> &rhs):size_(0), root_(shared_ptr<Node>(nullptr))
{
    this->RecursiveCopy(rhs.root_);
}

template<typename T1, typename T2>
MapSecond<T1, T2>::MapSecond(MapSecond<T1, T2> &&rhs) noexcept: size_(0), root_(shared_ptr<Node>(nullptr))
{
    this->Clear();
...
template<typename T1, typename T2>
void MapSecond<T1, T2>::Add(const pair<T1, T2> &new_item)
{
    ...
    auto new_element = make_shared<Node>(Node(new_item, shared_ptr<Node>(nullptr)));
    if (this->size_ != 0)
    {
        ...
        new_item.first <= parent->value_.first ? (parent->left_child_ = new_element)
    ...
    this->UpdateList(new_element, true);
}

template<typename T1, typename T2>
void MapSecond<T1, T2>::Delete(const T1 &key)
{
    auto search_element = this->FindElement(key);
    if (search_element != shared_ptr<Node>(nullptr) && this->size_ > 0)
    {
        this->UpdateList(search_element, false);
...
template<typename T1, typename T2>
constexpr bool MapSecond<T1, T2>::Has(const T1 &key) const noexcept
{
    return this->FindElement(key) != shared_ptr<Node>(nullptr);
}

template<typename T1, typename T2>
constexpr size_t MapSecond<T1, T2>::Size() const noexcept
{
    return this->size_;
}

template<typename T1, typename T2>
constexpr bool MapSecond<T1, T2>::Empty() const noexcept
{
    return this->size_ == 0;
}

template<typename T1, typename T2>
constexpr T2 MapSecond<T1, T2>::FindNext(const T1 &key) const
{
    return ((this->NextElement(this->FindElement(key)))->value_).second;
}

template<typename T1, typename T2>
constexpr T2 MapSecond<T1, T2>::FindPrevious(const T1 &key) const
{
    return ((this->PreviousElement(this->FindElement(key)))->value_).second;
}

template<typename T1, typename T2>
ostream &operator<<(ostream &os, const MapSecond<T1, T2> &element)
{
...
template<typename T1, typename T2>
T2 &MapSecond<T1, T2>::operator[](const T1 &value)
{
    return ((this->FindElement(value))->value_).second;
}

template<typename T1, typename T2>
MapSecond<T1, T2> &MapSecond<T1, T2>::operator=(MapSecond<T1, T2> &&rhs) noexcept
{
    this->Clear();
    this->root_ = rhs.root_;
    auto rhs_left = rhs.root_->left_child_,
...
template<typename T1, typename T2>
MapSecond<T1, T2>::Node::Node(const pair<T1, T2> &value, shared_ptr<Node> parent)
        :value_(value), parent_(parent), left_child_(nullptr), right_child_(nullptr)
{}

template<typename T1, typename T2>
void MapSecond<T1, T2>::RecursiveCopy(const shared_ptr<Node> &rhs)
{
...
template<typename T1, typename T2>
void MapSecond<T1, T2>::RecursivePrint(const shared_ptr<Node> &element, ostream &os) const
{
...
template<typename T1, typename T2>
shared_ptr<typename MapSecond<T1, T2>::Node> MapSecond<T1, T2>::FindElement(const T1 &key) const
{
...
template<typename T1, typename T2>
typename MapSecond<T1, T2>::Iterator MapSecond<T1, T2>::begin()
{
    return Iterator(this, *(this->links_to_nodes_.begin()));
}

template<typename T1, typename T2>
typename MapSecond<T1, T2>::Iterator MapSecond<T1, T2>::end()
{
    return Iterator(this, *(this->links_to_nodes_.rbegin()));
}

template<typename T1, typename T2>
void MapSecond<T1, T2>::UpdateList(const shared_ptr<Node> &element, const bool &query)
{
    if (query)
    {
        if (element == this->GetMaximumValue(this->root_))
            this->links_to_nodes_.push_back(element);
        else if (element == this->GetMinimumValue((this->root_)))
            this->links_to_nodes_.push_front(element);
        else
            this->links_to_nodes_
                    .insert(find(this->links_to_nodes_.begin(), this->links_to_nodes_.end(),
                                 this->NextElement(element)),
                            element);
    }
    else
    {
        this->links_to_nodes_.erase(find(this->links_to_nodes_.begin(), this->links_to_nodes_.end(), element));
    }
}


template<typename T1, typename T2>
void MapSecond<T1, T2>::DeleteByPointer(shared_ptr<Node> &target)
{
...
template<typename T1, typename T2>
shared_ptr<typename MapSecond<T1, T2>::Node>
MapSecond<T1, T2>::GetMaximumValue(const shared_ptr<Node> &start) const noexcept
{
    auto response = start;
...
template<typename T1, typename T2>
shared_ptr<typename MapSecond<T1, T2>::Node>
MapSecond<T1, T2>::GetMinimumValue(const shared_ptr<Node> &start) const noexcept
{
    auto response = start;
...
template<typename T1, typename T2>
shared_ptr<typename MapSecond<T1, T2>::Node> MapSecond<T1, T2>::NextElement(shared_ptr<Node> target) const
{
...
template<typename T1, typename T2>
shared_ptr<typename MapSecond<T1, T2>::Node> MapSecond<T1, T2>::PreviousElement(shared_ptr<Node> target) const
{
...
template<typename T1, typename T2>
void MapSecond<T1, T2>::DeleteTree(shared_ptr<Node> &node)
{
...
template<typename T1, typename T2>
class MapSecond<T1, T2>::Iterator : std::iterator<std::bidirectional_iterator_tag, T1>
{
public:
    Iterator();

    Iterator(MapSecond<T1, T2> *, shared_ptr<Node> &);
...
template<typename T1, typename T2>
MapSecond<T1, T2>::Iterator::Iterator(): object_(shared_ptr<Node>(nullptr))
{}

template<typename T1, typename T2>
MapSecond<T1, T2>::Iterator::Iterator(MapSecond<T1, T2> *owner, shared_ptr<Node> &link): owner_(owner), object_(link)
{}

template<typename T1, typename T2>
T2 &MapSecond<T1, T2>::Iterator::operator*()
{
    return this->object_->value_.second;
}

template<typename T1, typename T2>
typename MapSecond<T1, T2>::Node *MapSecond<T1, T2>::Iterator::operator->()
{
    return this->object_;
}

template<typename T1, typename T2>
T2 MapSecond<T1, T2>::Iterator::operator*() const
{
    return *this->object_->value_.second;
}

template<typename T1, typename T2>
typename MapSecond<T1, T2>::Iterator &MapSecond<T1, T2>::Iterator::operator--()
{
...
template<typename T1, typename T2>
bool MapSecond<T1, T2>::Iterator::operator==(const MapSecond<T1, T2>::Iterator &it) const
{
...
template<typename T1, typename T2>
const typename MapSecond<T1, T2>::Iterator MapSecond<T1, T2>::Iterator::operator++(int)
{
